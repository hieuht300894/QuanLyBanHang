...
{
    public class clsDelete<T> : clsTemplate<T> where T : class, new()
    {
        #region Constructor
        private static volatile clsDelete<T> instance = null;
        private static readonly object mLock = new object();
        protected clsDelete() { }
        public new static clsDelete<T> Instance
        {
            get
            {
                if (instance == null)
        ...
        public virtual bool RemoveEntry()
        {

...
namespace QuanLyBanHang.BLL.PERS
{
    ...
    public class clsPersonnel : clsFuction<xPersonnel>
    {
        public clsPersonnel(string FormName, string ControlName) : base(FormName, ControlName)
        {
        }

        public override void bWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            Select();
        }
    }

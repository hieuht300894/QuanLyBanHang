...
namespace QuanLyBanHang
{
    public partial class frmBase : XtraForm
    {
        ...
        protected virtual void OpenProgress()
        {
            Action action = () =>
            {
        ...
        #region LoadData
        public virtual void LoadData<T>(int KeyID, GridControl gctMain, IList<T> ListData, Dictionary<string, object> dValueFrom, Dictionary<string, object> dValueTo, bool IsShowPercent = false, bool IsShowMessage = false, bool IsShowError = false) where T : class, new()
        {
        ...
        public virtual void LoadData<T>(int KeyID, LookUpEdit lokMain, IList<T> ListData, Dictionary<string, object> dValueFrom, Dictionary<string, object> dValueTo, bool IsShowPercent = false, bool IsShowMessage = false, bool IsShowError = false) where T : class, new()
        {
        ...
        public virtual void LoadData<T>(int KeyID, RepositoryItemLookUpEdit rlokMain, IList<T> ListData, Dictionary<string, object> dValueFrom, Dictionary<string, object> dValueTo, bool IsShowPercent = false, bool IsShowMessage = false, bool IsShowError = false) where T : class, new()
        {
        ...
        #region Custom Form
        public virtual void CustomForm(List<string> lstMethods, bool IsShowPercent = false, bool IsShowMessage = false, bool IsShowError = false)
        {
            lstMethods = lstMethods ?? new List<string>();

            clsCustomForm custom = new clsCustomForm();
            custom.Init();
            custom.SetEntity(lstMethods);
            SetAction(custom, IsShowPercent, IsShowMessage, IsShowError);
            custom._CallMethod = CallMethod;
            custom.StartRun();
        }
